...
export const getBuyerOAuth = () => {
  return sessionStorage.getItem('buyerOAuth');
};

export const storeBuyerOAuth = oauth => {
  sessionStorage.setItem('buyerOAuth', oauth);
};

export const getSellerOAuth = () => {
  return sessionStorage.getItem('sellerOAuth');
};

export const storeSellerOAuth = oauth => {
